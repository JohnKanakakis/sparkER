...
public class DataParser {
	...
	public static void main(String[] args){
		String triple = "<http://dblp.l3s.de/d2r/resource/publications/conf/sac/DamianiF95> <http://purl.org/dc/terms/issued> \"1995\"";
		System.out.println(toTriple(new Text(triple),new ArrayList<String>(3)));
	}
	
	private  static List<String> toTriple(Text t,List<String> buffer){
					...
					data.mapToPair(
			        		new PairFunction<Tuple2<LongWritable,Text>,String, Tuple2<String,String>>(){
			        			...
			        			public Tuple2<String, Tuple2<String, String>> call(Tuple2<LongWritable,Text> record) throws Exception {
			        				...
			        				Text tripleText = record._2;
			    					triple = toTriple(tripleText, buffer);
	...
	/*public static JavaPairRDD<String, Tuple2<String, String>> parse(
